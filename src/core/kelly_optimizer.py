...
class KellyOptimizer:
    ...
    Examples:
        >>> optimizer = KellyOptimizer(bankroll=10000.0, db_path='nba_betting_data.db')
    ...
    def __init__(self, bankroll: float = 10000.0, db_path: str = "nba_betting_data.db"):
        """
        ...
        Args:
            ...
            db_path (str): Path to SQLite database for bet tracking. Default: 'nba_betting_data.db'
        ...
        # Kelly fraction for bet sizing (0.0 to 1.0, typically 0.1-0.5)
