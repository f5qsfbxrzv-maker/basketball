...
from config.data_models import GameInfo, GameFeatures, PredictionResult
...
class PredictionEngine:
    ...
    **CRITICAL WORKFLOW**:
    ...
    Examples:
        ...
        >>> fitter = CalibrationFitter(db_path='nba_betting_data.db')
        >>> logger = CalibrationLogger(db_path='nba_betting_data.db')
